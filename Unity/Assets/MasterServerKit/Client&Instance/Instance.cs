...
namespace Msk
{
    public partial class MasterServerKit
    {
        public class Instance
        {
            ...
            /// <summary>
            /// Is this room registered to the master server?
            /// </summary>
            ...
            /// <summary>
            /// Command args of the executable file.
            /// </summary>
            ...
            private static void RegisterRoom()
            {
                ...
                if (IsRoomRegistered)
                {
                    Debug.LogError("This room is already been registered to the master server!");
                    return;
                }
